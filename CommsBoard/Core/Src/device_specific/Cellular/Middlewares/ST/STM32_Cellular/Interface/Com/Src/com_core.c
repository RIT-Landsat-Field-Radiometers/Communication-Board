...
#include "Cellular/Middlewares/ST/STM32_Cellular/Interface/Com/Inc/com_sockets.h"
#include "Cellular/Middlewares/ST/STM32_Cellular/Interface/Com/Inc/com_trace.h"
#include "Cellular/Config/plf_config.h"


#if (USE_COM_ICC == 1)
#include "Cellular/Middlewares/ST/STM32_Cellular/Interface/Com/Inc/com_icc.h"
#endif /* USE_COM_ICC == 1 */
