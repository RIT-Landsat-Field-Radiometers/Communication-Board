...
#include "main.h"
#include "Cellular/Drivers/BSP/AT_modem_bg96/Inc/plf_modem_config.h"
#include "usart.h"
...
#define MODEM_TX_GPIO_PORT               ((GPIO_TypeDef *)MDM_TX_GPIO_Port)   /* for DiscoL496: GPIOB       */
#define MODEM_TX_PIN                     MDM_TX_Pin                           /* for DiscoL496: GPIO_PIN_6  */
#define MODEM_RX_GPIO_PORT               ((GPIO_TypeDef *)MDM_RX_GPIO_Port)    /* for DiscoL496: GPIOG       */
#define MODEM_RX_PIN                     MDM_RX_Pin                            /* for DiscoL496: GPIO_PIN_10 */
#define MODEM_CTS_GPIO_PORT              ((GPIO_TypeDef *)MDM_CTS_GPIO_Port)   /* for DiscoL496: GPIOG       */
#define MODEM_CTS_PIN                    MDM_CTS_Pin                           /* for DiscoL496: GPIO_PIN_11 */
#define MODEM_RTS_GPIO_PORT              ((GPIO_TypeDef *)MDM_RTS_GPIO_Port)   /* for DiscoL496: GPIOG       */
#define MODEM_RTS_PIN                    MDM_RTS_Pin                           /* for DiscoL496: GPIO_PIN_12 */
...
#define MODEM_RST_GPIO_PORT              ((GPIO_TypeDef *)MDM_RST_GPIO_Port)    /* for DiscoL496: GPIOB      */
#define MODEM_RST_PIN                    MDM_RST_Pin                            /* for DiscoL496: GPIO_PIN_2 */
#define MODEM_PWR_EN_GPIO_PORT           ((GPIO_TypeDef *)MDM_ONOFF_GPIO_Port) /* for DiscoL496: GPIOD      */
#define MODEM_PWR_EN_PIN                 MDM_ONOFF_Pin                         /* for DiscoL496: GPIO_PIN_3 */
#define MODEM_DTR_GPIO_PORT              ((GPIO_TypeDef *)MDM_DTR_GPIO_Port)    /* for DiscoL496: GPIOA      */
#define MODEM_DTR_PIN                    MDM_DTR_Pin                            /* for DiscoL496: GPIO_PIN_0 */
/* input */
#define MODEM_RING_GPIO_PORT             ((GPIO_TypeDef *)MDM_RING_GPIO_Port)  /* for DiscoL496: GPIOH      */
#define MODEM_RING_PIN                   MDM_RING_Pin                          /* for DiscoL496: GPIO_PIN_2 */
