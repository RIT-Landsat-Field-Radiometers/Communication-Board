...
#define CO_CONFIG_NMT (CO_CONFIG_NMT_MASTER)//(CO_CONFIG_NMT_CALLBACK_CHANGE | CO_CONFIG_NMT_MASTER)
...
#define CO_CONFIG_HB_CONS (0)//(CO_CONFIG_HB_CONS_ENABLE | CO_CONFIG_HB_CONS_CALLBACK_CHANGE | CO_CONFIG_HB_CONS_QUERY_FUNCT)
...
#define CO_CONFIG_SYNC (0)//(CO_CONFIG_SYNC_ENABLE | CO_CONFIG_SYNC_PRODUCER | CO_CONFIG_FLAG_OD_DYNAMIC)
...
#define CO_CONFIG_PDO (CO_CONFIG_RPDO_ENABLE/* | CO_CONFIG_RPDO_TIMERS_ENABLE | CO_CONFIG_PDO_SYNC_ENABLE */| CO_CONFIG_PDO_OD_IO_ACCESS)
...
#define CO_CONFIG_GTW (0)//(CO_CONFIG_GTW_ASCII | CO_CONFIG_GTW_ASCII_ERROR_DESC | CO_CONFIG_GTW_ASCII_PRINT_HELP | CO_CONFIG_GTW_ASCII_PRINT_LEDS | CO_CONFIG_GTW_ASCII_LOG)
...
void coLogDebug(const char *fmt);
void coLogDebugF(const char *fmt, ...);


#define CO_DEBUG_COMMON(msg) (void*)msg;//coLogDebug(msg);//"%s:%d- " msg, "fn", __LINE__);

#define CO_DEBUG_COMMONF(msg, ...) (void*)msg;//coLogDebug(msg);//coLogDebugF(msg, __VA_ARGS__);//"%s:%d- " msg, "fn", __LINE__, __VA_ARGS__);
