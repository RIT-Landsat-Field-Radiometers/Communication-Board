...
#define BAT_LVL_GPIO_Port GPIOC
#define TP9_Pin GPIO_PIN_4
#define TP9_GPIO_Port GPIOC
#define Boron_CS_Pin GPIO_PIN_1
#define Boron_CS_GPIO_Port GPIOB
#define Boron_RST_Pin GPIO_PIN_8
#define Boron_RST_GPIO_Port GPIOE
#define Boron_MODE_Pin GPIO_PIN_11
#define Boron_MODE_GPIO_Port GPIOE
#define Boron_EN_Pin GPIO_PIN_14
#define Boron_EN_GPIO_Port GPIOE
...
#define Boron_RDY_Pin GPIO_PIN_13
#define Boron_RDY_GPIO_Port GPIOB
