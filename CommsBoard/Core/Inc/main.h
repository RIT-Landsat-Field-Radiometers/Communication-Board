...
#define TP17_Pin GPIO_PIN_1
#define TP17_GPIO_Port GPIOB
#define TP_RST_Pin GPIO_PIN_8
#define TP_RST_GPIO_Port GPIOE
#define MDM_DTR_Pin GPIO_PIN_11
#define MDM_DTR_GPIO_Port GPIOE
#define TP_EN_Pin GPIO_PIN_14
#define TP_EN_GPIO_Port GPIOE
...
#define MDM_ONOFF_Pin GPIO_PIN_13
#define MDM_ONOFF_GPIO_Port GPIOB
