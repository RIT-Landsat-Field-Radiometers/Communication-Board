...
Core/Src/device_specific/HTTP/mbed-http/http_parser/%.o Core/Src/device_specific/HTTP/mbed-http/http_parser/%.su Core/Src/device_specific/HTTP/mbed-http/http_parser/%.cyclo: ../Core/Src/device_specific/HTTP/mbed-http/http_parser/%.c Core/Src/device_specific/HTTP/mbed-http/http_parser/subdir.mk
...
clean-Core-2f-Src-2f-device_specific-2f-HTTP-2f-mbed-2d-http-2f-http_parser:
	-$(RM) ./Core/Src/device_specific/HTTP/mbed-http/http_parser/http_parser.cyclo ./Core/Src/device_specific/HTTP/mbed-http/http_parser/http_parser.d ./Core/Src/device_specific/HTTP/mbed-http/http_parser/http_parser.o ./Core/Src/device_specific/HTTP/mbed-http/http_parser/http_parser.su
